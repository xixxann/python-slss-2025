...
class Cookie(pygame.sprite.Sprite):
    ...
    def update(self):
        """Update Cookie's location based on the mouse pos and
...
def game():
    ...
    get_coin = pygame.mixer.Sound("assets/receivecoin.mp3")
    lose_health = pygame.mixer.Sound("assets/losehealth.mp3")
